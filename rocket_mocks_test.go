...
// Source: github.com/GlebZigert/go-grpc-service-course/internal/rocket (interfaces: Store)
...
import (
	...
	rocket "github.com/GlebZigert/go-grpc-service-course/internal/rocket"
...
func (m *MockStore) GetRocketByID(arg0 string) (rocket.Rocket, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRocketByID", arg0)
	ret0, _ := ret[0].(rocket.Rocket)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) InsertRocket(arg0 rocket.Rocket) (rocket.Rocket, error) {
	m.ctrl.T.Helper()
